...
- Stage 6 Agent-discoverable — DONE. Listed on the official MCP registry: io.github.Kevthetech143/chain-signer (confirmed live via API). Sequence: ~/agents/global/tools/version-control/mcp-registry-publish-sequence.md. (Registry manifest shows 0.1.3 live; 0.1.4 republish pending a re-auth — to be eliminated by CI/OIDC.)
